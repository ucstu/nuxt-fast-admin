...
import type { FastAuthForm, FastAuthToken, RefreshSignInResult } from "../types";
import {
  useAuth,
  type AuthStatus,
  type SignInOptions,
 ...
 * @returns 刷新认证
 */
export const useRefreshAuth = createGlobalState(
  <F extends FastAuthForm = FastAuthForm>(nuxtApp = useNuxtApp()) => {
